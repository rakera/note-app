...
export class Notes1717075835378 implements MigrationInterface {
    name = 'Notes1717075835378'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "notes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" bigint NOT NULL, "text" character varying NOT NULL, "create_date" TIMESTAMP(0) NOT NULL DEFAULT now(), "update_date" TIMESTAMP(0) NOT NULL DEFAULT now(), "share_id" character varying, CONSTRAINT "UQ_30041dc98d0f4a5843d6d8072cd" UNIQUE ("share_id"), CONSTRAINT "PK_af6206538ea96c4e77e9f400c3d" PRIMARY KEY ("id"))`);
